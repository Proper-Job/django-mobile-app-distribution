...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field groups on 'App'
        m2m_table_name = db.shorten_name(u'django_mobile_app_distribution_app_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('app', models.ForeignKey(orm[u'django_mobile_app_distribution.app'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['app_id', 'group_id'])


        # Changing field 'App.user'
        db.alter_column(u'django_mobile_app_distribution_app', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Removing M2M table for field groups on 'App'
        db.delete_table(db.shorten_name(u'django_mobile_app_distribution_app_groups'))


        # Changing field 'App.user'
        db.alter_column(u'django_mobile_app_distribution_app', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
